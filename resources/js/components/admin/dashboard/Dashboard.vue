          ...
          <div class="col-sm-7">
            ...
            <a href="/admin/pedidos/licenca">
              <div class="infobox infobox-green" style="height: 90px">
                ...
                <div class="infobox-data">
                  <span class="infobox-data-number">{{
                    countlicencasativas | formatQt
                  }}</span>
                  <div class="infobox-content" style="color: black">
                    Pedido activação Licenças activas
                  </div>
                </div>
              </div>
            </a>
            ...
            <a href="/admin/pedidos/licenca">
              <div class="infobox infobox-green2" style="height: 90px">
                ...
                <div class="infobox-data">
                  <span class="infobox-data-number">{{
                    countlicencaspendente | formatQt
                  }}</span>
                  <div
                    class="infobox-content"
                    style="color: black; font-size: 12px"
                  >
                    Pedido activação Licenças Pendentes
                  </div>
                </div>
              </div>
            </a>
            ...
            <a href="/admin/pedidos/licenca">
              <div class="infobox infobox-orange2" style="height: 90px">
                ...
                <div class="infobox-data">
                  <span class="infobox-data-number">{{
                    countlicencasrejeitada | formatQt
                  }}</span>
                  <div class="infobox-content" style="color: black">
                    Pedido activação Licenças Rejeitadas
                  </div>
                </div>
              </div>
            </a>
