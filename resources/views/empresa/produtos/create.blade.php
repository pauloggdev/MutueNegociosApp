                    ...
                    <div class="tabbable">
                        <div class="tab-content profile-edit-tab-content">
                            ...
                            <div class="form-group has-info bold" style="left: 0%; position: relative">
                                ...
                                <div class="col-md-6">
                                    <label class="control-label bold label-select2" for="imagens">Imagem adicionais</label>
                                    <div class="input-group">
                                        <input type="file" multiple accept="application/image/*" wire:model="produto.imagens" class="form-control" id="imagens" autofocus style="height: 35px; font-size: 10pt;<?= $errors->has('produto.imagens') ? 'border-color: #ff9292;' : '' ?>" />
                                        <span class="input-group-addon" id="basic-addon1">
                                            <i class="ace-icon fa fa-info bigger-150 text-info" data-target="form_supply_price_smartprice"></i>
                                        </span>
                                    </div>
