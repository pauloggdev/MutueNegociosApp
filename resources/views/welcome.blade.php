    ...
    <div class="col-md-5">
        <div class="form">
            ...
            <form action="{{ route('login') }}" id="contact-form" method="POST">
                ...
                @endif
                <input class="form-control" name="email" value="{{ old('email') }}" required type="text"
                    autocomplete="off" placeholder="E-email / telefone">
                <input class="form-control" name="password" value="{{ old('password') }}" required type="password"
                    placeholder="Senha">
