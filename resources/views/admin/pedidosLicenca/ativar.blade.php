            ...
            <div class="tabbable" style="margin-top:30px">
                ...
                <div class="tab-content profile-edit-tab-content">
                    ...
                    <div>
                            ...
                            <button id="botoes" type="submit" style="margin-top:20px" class="btn btn-success widget-box widget-color-blue" wire:click.prevent="activarLicenca({{$pedido->id}})">ATIVAR LICENÇA</button>
                    </div>
