...
<head>
	...
	<title>Acesso Mutue Negócios</title>
</head>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="error-template">
					<h1>:)</h1>
					<h3>A sua empresa foi validado no nosso sistema, acessa o aplicativo Mutue</h3>
					<div class="error-details">
						Caso deseja acessar apartir do navegador, clica no botão abaixo e adiciona as credênciais enviadas por email
					</div>
