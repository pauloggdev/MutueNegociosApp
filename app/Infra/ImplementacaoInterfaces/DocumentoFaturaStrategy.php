...
class DocumentoFaturaStrategy implements TipoDocumentoStrategy
{
    public function gerarNumeracao($nomeEmpresa, $numSequencia, $ano): string
    {
        return "FT $nomeEmpresa$ano/$numSequencia";
    }

    public function obterNumSequencia($numeroSerieDocumento, $ano, INumSequenciaRepository $repository): int
    {
        return $repository->obterNumSequencia($numeroSerieDocumento, $ano, EnumTipoDocumento::$FATURA);
    }
}
